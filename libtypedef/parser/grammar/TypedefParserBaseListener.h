...
public:
  ...
  virtual void enterSymrefMemberDeclaration(TypedefParser::SymrefMemberDeclarationContext * /*ctx*/) override { }
  virtual void exitSymrefMemberDeclaration(TypedefParser::SymrefMemberDeclarationContext * /*ctx*/) override { }
