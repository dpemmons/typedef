...
// td::codegen::experimental::cpp::TdType variant declaration.
class TdType {
 public:
...
// td::codegen::experimental::cpp::AccessInfo::access_byT variant declaration.
class access_byT {
 public:
  // Nested type declarations
...
// td::codegen::experimental::cpp::UserTypeDeclaration variant declaration.
class UserTypeDeclaration {
 public:
  // Nested type declarations
...
// td::codegen::experimental::cpp::TmplForBlock::binding_varsT variant declaration.
class binding_varsT {
 public:
  // Nested type declarations
...
// td::codegen::experimental::cpp::TmplItem variant declaration.
class TmplItem {
 public:
  // Nested type declarations
...
std::string TmplStructDeclaration(const StructDecl& s, const Options& opt);void TmplStructDefinition(std::ostream& os, const StructDecl& s, const Options& opt);
...
std::string CppSource(const CppData& d, const Options& opt);void VecUserTypeDeclarationT(std::ostream& os, const td::Vector<UserTypeDeclaration>& ut, const Options& opt);
std::string VecUserTypeDeclarationT(const td::Vector<UserTypeDeclaration>& ut, const Options& opt);void CppType(std::ostream& os, const AccessInfo& a);
std::string CppType(const AccessInfo& a);void QualifiedName(std::ostream& os, const td::Vector<std::string>& fqn);
std::string QualifiedName(const td::Vector<std::string>& fqn);void QualifiedSnakeName(std::ostream& os, const td::Vector<std::string>& fqn);
std::string QualifiedSnakeName(const td::Vector<std::string>& fqn);void JsonPrintKey(std::ostream& os, const AccessInfo& field);
...
std::string TmplValueDereferenceT(const TmplValueDereference& v);void TmplStringExpression(std::ostream& os, const TmplExpression& i);
...
std::string TmplSwitchT(const SwitchBlock& s);void TmplItemsT(std::ostream& os, const td::Vector<TmplItem>& v);
std::string TmplItemsT(const td::Vector<TmplItem>& v);void TmplItemT(std::ostream& os, const TmplItem& i);
std::string TmplItemT(const TmplItem& i);void OStreamParamsList(std::ostream& os, const td::Vector<AccessInfo>& params);
std::string OStreamParamsList(const td::Vector<AccessInfo>& params);void ParamsList(std::ostream& os, const td::Vector<AccessInfo>& params);
std::string ParamsList(const td::Vector<AccessInfo>& params);void TmplFuncDeclaration(std::ostream& os, const TmplFunction& t);
