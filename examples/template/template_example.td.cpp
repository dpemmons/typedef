...
os << "\"name\":"; os << "\"" << td::escape_json(from.name()) << "\"";
os << ",";
os << "\"has_name\":"; os << (from.has_name() ? "true" : "false");
os << ",";
os << "\"name2\":"; os << "\"" << td::escape_json(from.name2()) << "\"";
os << ",";
...
os << "\"a_string\":"; os << "\"" << td::escape_json(from.a_string()) << "\"";
...
os << "\"c_char\":"; os << "\"" << td::char32ToJsonString(from.c_char()) << "\"";
